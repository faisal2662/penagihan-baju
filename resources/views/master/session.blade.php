                                ...
                                <tbody>
                                    @foreach ($session as $item)
                                        <tr>
                                            ...
                                            <td style="max-width:100%;white-space:nowrap;">{{ $item->date }}</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Sesi</h1>
    ...
    @foreach ($session as $item)
        <div class="modal fade" id="edit{{ $item->slug }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Update Sesi</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="/session/{{ $item->slug }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="modal-body">
                            <div class="mb-3">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p> Sesi :<strong> {{ $item->name }}</strong></p>
                    </div>
                    <form action="/session/{{ $item->slug }}" method="POST">
                        @csrf
                        @method('delete')
